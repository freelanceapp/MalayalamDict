 ...
 * Time: 15:49.
 */
public class MerialCheckBox extends android.widget.CheckBox {
    ...
    public MerialCheckBox(Context context) {
        this(context, null);
    }

    public MerialCheckBox(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MerialCheckBox(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.MerialCheckBox);
        mColor = attributes.getColor(R.styleable.MerialCheckBox_checkbox_color,
                getResources().getColor(R.color.checkbox_color));
        mCheckedColor = attributes.getColor(R.styleable.MerialCheckBox_checkbox_checked_color,
